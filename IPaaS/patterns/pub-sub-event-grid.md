...
## (2) Push-based with Event Grid
When using the push-based model, notified endpoints must be internet facing. This is a strong show stopper in Hub & Spoke. 

## (3) Handlers can become a potential bottleneck
