...
In a nutshell, Traffic Manager directs traffic to Front Door. If Front Door becomes unhealthy, the fallback path relies on an intermediate Traffic Manager, which then routes traffic to the closest Application Gateway.